    ...
    <div className={`bg-gradient-to-b from-gray-900 via-gray-900 to-gray-800 border-r border-gray-700/50 shadow-2xl transition-all duration-300 ease-in-out ${
      ...
      <div className="p-4 border-b border-gray-700/30 bg-gradient-to-r from-gray-900/50 to-gray-800/30">
        <div className="flex items-center justify-between">
          ...
          {isCollapsed && (
            <div className="w-10 h-10 bg-gradient-to-br from-[#e07a4a] via-[#d2691e] to-[#b8860b] rounded-xl flex items-center justify-center mx-auto shadow-lg ring-1 ring-white/10 cursor-pointer hover:opacity-80 transition-opacity" onClick={handleLogoClick}>
              <span className="text-white font-bold text-lg">D</span>
            </div>
          )}
          <button
      ...
      <div className="p-4">
        <button 
          ...
          className="w-full bg-gradient-to-r from-[#e07a4a] to-[#d2691e] hover:from-[#d2691e] hover:to-[#b8860b] text-white rounded-xl p-3 transition-all duration-300 hover:shadow-xl hover:shadow-[#e07a4a]/25 flex items-center justify-center gap-2 group"
        >
          {!isCollapsed ? (
            <>
      ...
      <div className="px-4 py-3 border-t border-gray-700/30">
        {!isCollapsed && (
          <div className="mb-3">
            ...
            <div className="text-xs text-gray-500 ml-4 leading-tight">
        ...
        <div className="space-y-1">
          <button
            ...
            className="w-full flex items-center gap-2 text-sm text-gray-300 hover:text-white px-3 py-2 rounded-lg hover:bg-gradient-to-r hover:from-gray-700/50 hover:to-gray-600/30 transition-all duration-200 group border border-transparent hover:border-gray-600/30"
      ...
      <div className="px-4 py-3 border-t border-gray-700/30">
        {!isCollapsed && (
          <div className="mb-3">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-xs text-gray-300 uppercase tracking-wider font-semibold">Data Connectors</span>
            </div>
            <div className="text-xs text-gray-500 ml-4 leading-tight">
        ...
        <div className="space-y-1">
          <button
            ...
            className="w-full flex items-center gap-2 text-sm text-gray-300 hover:text-white px-3 py-2 rounded-lg hover:bg-gradient-to-r hover:from-gray-700/50 hover:to-gray-600/30 transition-all duration-200 group border border-transparent hover:border-gray-600/30"
            title={isCollapsed ? "Manage Data Connectors" : undefined}
          >
            {isCollapsed ? (
              <div className="w-8 h-8 bg-gradient-to-br from-orange-500/20 to-orange-600/20 rounded-lg flex items-center justify-center mx-auto group-hover:from-orange-500/30 group-hover:to-orange-600/30 transition-all">
                <span className="text-orange-400 text-xs font-bold">D</span>
              </div>
            ) : (
              <>
                <div className="w-8 h-8 bg-gradient-to-br from-orange-500/20 to-orange-600/20 rounded-lg flex items-center justify-center group-hover:from-orange-500/30 group-hover:to-orange-600/30 transition-all">
                  <span className="text-orange-400 text-xs font-bold">D</span>
                </div>
                <div className="flex-1 text-left min-w-0">
                  <div className="text-sm font-semibold break-words group-hover:text-white transition-colors">Manage Data Connectors</div>
                  <div className="text-xs text-gray-500 break-words group-hover:text-gray-300 transition-colors">APIs, databases, and external systems</div>
                </div>
                <div className="w-5 h-5 bg-gray-600/50 rounded-md flex items-center justify-center group-hover:bg-gray-500/50 transition-colors">
                  <span className="text-gray-400 text-xs group-hover:text-white transition-colors">→</span>
                </div>
